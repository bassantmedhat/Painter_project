...
public:
    ...
    //PaintArea(QVector<Shapes*>* vectparea);
    // File Operation
    bool openImage(const QString &fileName);
    bool saveImage(const QString &fileName, const char *fileFormat);
    static QVector<Shapes*> * getvector();
    // Options
...
//     void show();
 //    bool istrue(const Shapes* first ,const Shapes* second);
    //QVector<Shapes*>* getvect();
    //void sortvect();
    bool modified;
    void setPenColor();
