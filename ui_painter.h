...
public:
    ...
    void setupUi(QMainWindow *Painter)
    {
        ...
        actionSort = new QAction(Painter);
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/img/mouse.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/img/eraser.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/img/line.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/img/rectangle.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QStringLiteral(":/img/circle.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QStringLiteral(":/img/rectangle_round.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon9;
        icon9.addFile(QStringLiteral(":/img/fill.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        horizontalLayout_5->addWidget(tool_Select);
        ...
        QIcon icon11;
        icon11.addFile(QStringLiteral(":/img/brush.png"), QSize(), QIcon::Normal, QIcon::Off);
        tool_spray->setIcon(icon11);
        tool_spray->setIconSize(QSize(32, 32));

        horizontalLayout_6->addWidget(tool_spray);
        ...
        horizontalLayout_9->addWidget(Sort);
        ...
        horizontalLayout_13->addWidget(Search);


        settings->addLayout(horizontalLayout_13);
    ...
    void retranslateUi(QMainWindow *Painter)
    {
        ...
        actionSort->setText(QApplication::translate("Painter", "Sort", 0));
        ...
        Sort->setText(QApplication::translate("Painter", "Sort", 0));
        Search->setText(QApplication::translate("Painter", "Search", 0));
