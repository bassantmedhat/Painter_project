...
void Painter::New_File()
{
    ...
    _fill_pen.setColor(QPalette::Window, Qt::black);
    _fill_back.setColor(QPalette::Window, Qt::white);
    _pen.setColor(QPalette::Window, QColor(0, 0, 0, 0));
    _back.setColor(QPalette::Window, QColor(0, 0, 0, 0));
...
{
    QPalette _pen = ui->color_pen->palette();
    _pen.setColor(QPalette::Window, color);
